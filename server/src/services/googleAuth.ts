...
export function getAuthUrl(oauth2Client: ReturnType<typeof createOAuth2Client>, state?: string) {
...
export async function getTokensFromCode(oauth2Client: ReturnType<typeof createOAuth2Client>, code: string) {
...
export async function refreshAccessToken(oauth2Client: ReturnType<typeof createOAuth2Client>, refreshToken: string) {
